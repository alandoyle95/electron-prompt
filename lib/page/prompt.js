...
docReady(() => {
    ...
    if(promptOptions.type === 'input') {
        ...
        for(let k in promptOptions.selectOptions) {
            ...
            console.log(k, ' = ', promptOptions.value)
            if(k === promptOptions.value && promptOptions.value && promptOptions.selectOptions[k] != '') {
                console.log(k, ' = ', promptOptions.value)
                console.log(k, ' = ', promptOptions.selectOptions[k])
